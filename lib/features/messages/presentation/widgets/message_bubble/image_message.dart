...
import 'package:final_nuntius/features/messages/presentation/screens/show_message_image_screen.dart';
    ...
    return GestureDetector(
      onTap: () => Go.to(
          ...
          screen: ShowMessageImageScreen(
            ...
            name: message.senderId == HiveHelper.getCurrentUser()!.uId
                ? "You"
                : MessagesCubit.get(context).user!.name!,
            date: message.date!,
          )),
      child: SizedBox(
        width: AppWidth.w250,
