...
import 'package:final_nuntius/features/stories/presentation/widgets/story_view/my_story_viewers/viewer_details.dart';
...
class ViewersBottomSheet extends StatelessWidget {
  ...
  const ViewersBottomSheet(
      {Key? key, required this.users, required this.viewsDateTime})
      : super(key: key);
